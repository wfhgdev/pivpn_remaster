...
Asegúrate de tener `curl` instalado, puedes instalar cURL (Cliente para URLs) con el comando: `sudo apt install curl`
...
Asegúrate de tener `git` instalado, puedes instalar Git (sistema de control de versiones) con el comando: `sudo apt install git`
